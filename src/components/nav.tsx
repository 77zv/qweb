...
const general = [
    {
        name: "Events",
        description: "View all of our upcoming events.",
        href: "events",
        icon: CalendarIcon
    },
    {
              ...
              <div
                className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                  <div className="flex justify-start lg:w-0 lg:flex-1">
                      <Link href="/">
                          <span className="sr-only">Queens Business Brigade</span>
                          <img
                  ...
                  <Popover.Group as="nav" className="hidden space-x-10 md:flex">
                      {
                          general.map((item) => (
                            ...
                            >
                                <div className="ml-4">
                                    <p
                                      className="text-base font-medium text-gray-500 hover:text-gray-900">{item.name}</p>
                                </div>
                            </Link>
                          ))
                      }
                                            ...
                                            <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                                {
                                                    [
                                                        ...resources,
                                                        ...(sessionData?.user?.role === "judge" ? judgeResources : []),
                                                        ...(sessionData?.user?.role === "admin" ? adminResources : [])
                                                    ].map(item => (
                                                      <Link
                                                        key={item.name}
                                                        href={item.href}
