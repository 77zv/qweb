        ...
        <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div className="mt-6 text-gray-500 space-y-6">
              <p className="text-lg">
                Global Business Brigades is an international movement of university students and
                professionals building economic opportunities in the developing world. We work alongside
                promising entrepreneurs and experienced year-round staff to create financial opportunities in
                remote, rural, and under resourced areas of Honduras, Panama, Ghana, and Nicaragua.
              </p>
            </div>
          </div>
